# ABOUTME: Unit tests for Proto3::Schema element classes (Step 6, T-schema-1/2).
...
{
    my $f1 = Proto3::Schema::Field->new( name => 'id',   number => 1, type => 'int32' );
    my $f2 = Proto3::Schema::Field->new( name => 'name', number => 2, type => 'string' );
...
{
    my $f1 = Proto3::Schema::Field->new( name => 'a', number => 1, type => 'int32' );
    my $f2 = Proto3::Schema::Field->new( name => 'b', number => 1, type => 'int32' );
    ...
    ok( ref $err && $err->isa('Proto3::Exception::Schema::DuplicateField'),
...
{
    my $f1 = Proto3::Schema::Field->new( name => 'a', number => 1, type => 'int32' );
    my $f2 = Proto3::Schema::Field->new( name => 'a', number => 2, type => 'int32' );
...
{
    my $scalar = Proto3::Schema::Field->new( name => 'n', number => 1, type => 'int32' );
    ...
    my $msg_field = Proto3::Schema::Field->new(
    ...
    my $map = Proto3::Schema::Field->new(
...
# --- 6.5: is_packed only true for packable repeated scalar ------------------
{
    ...
    my $packed_int = Proto3::Schema::Field->new(
    ...
    my $packed_enum = Proto3::Schema::Field->new(
    ...
    my $packed_singular = Proto3::Schema::Field->new(
    ...
    my $packed_string = Proto3::Schema::Field->new(
    ...
    my $packed_msg = Proto3::Schema::Field->new(
    ...
    my $unpacked = Proto3::Schema::Field->new(
...
# --- 6.6: Enum allow_alias validation --------------------------------------
{
    ...
    my $ok_enum = Proto3::Schema::Enum->new(
...
{
    my $of = Proto3::Schema::Oneof->new( name => 'choice', oneof_index => 0 );
