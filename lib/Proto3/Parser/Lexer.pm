# ABOUTME: Proto3::Parser::Lexer — hand-written tokenizer for .proto source (spec §4.4).
# Produces an ordered token stream (type, value, line, col); discards comments;
# raises Proto3::Exception::Parser with line/column on unterminated string/comment.
use v5.38;
use strict;
use warnings;

package Proto3::Parser::Lexer;
...
Proto3::Parser::Lexer - hand-written tokenizer for .proto source

=head1 SYNOPSIS

    use Proto3::Parser::Lexer;

    my $lexer  = Proto3::Parser::Lexer->new( source => $proto_text );
...
recursive-descent grammar (L<Proto3::Parser::Grammar>) to consume. The lexer is
...
L<Proto3::Exception::Parser> (carrying C<line> and C<column>) on an unterminated
