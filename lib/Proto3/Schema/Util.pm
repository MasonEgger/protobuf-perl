...
# (Proto3::Schema::Util::assert_unique(...)) to avoid the feature 'class'
...
Proto3::Schema::Util - Construction-time validation helpers for the schema model

=head1 DESCRIPTION

Internal helper used by the C<Proto3::Schema::*> element classes to enforce
