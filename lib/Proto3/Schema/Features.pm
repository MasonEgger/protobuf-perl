...
# with Proto3::Exception::Schema for an unknown edition — defaults are a closed
# set, an unexpected edition is a bug we want surfaced loudly.
sub Proto3::Schema::Features::for_edition ($class, $edition) {
    my $defaults = $EDITION_DEFAULTS{$edition}
        or Proto3::Exception::Schema->throw(
...
sub Proto3::Schema::Features::merge ($class, $base, $override = {}) {
...
Proto3::Schema::Features - The editions FeatureSet model and resolution
...
=head1 SYNOPSIS
    ...
    my $merged = Proto3::Schema::Features->merge(
...
=item C<< Proto3::Schema::Features->for_edition($edition) >>

Return the default FeatureSet for C<'proto2'>, C<'proto3'>, or C<'2023'>. Dies
with L<Proto3::Exception::Schema> for an unknown edition.

=item C<< Proto3::Schema::Features->merge($base, $override) >>
