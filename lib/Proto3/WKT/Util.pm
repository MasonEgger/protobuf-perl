...
# Used by Proto3::WKT::Timestamp and Proto3::WKT::Duration; not public API.
use v5.38;
use warnings;

package Proto3::WKT::Util;
...
Proto3::WKT::Util - RFC3339 and fractional-seconds helpers for well-known types

=head1 DESCRIPTION

Internal helpers shared by L<Proto3::WKT::Timestamp> and L<Proto3::WKT::Duration>
...
nine digits. Dies C<Proto3::Exception::JSON::WKT> on non-digit or over-long input.
...
C<Proto3::Exception::JSON::WKT> on a malformed prefix.
