...
Proto3::WKT::Empty - the google.protobuf.Empty well-known type

=head1 SYNOPSIS

    use Proto3::WKT::Empty;

    my $json = Proto3::WKT::Empty->to_json_value( {} );    # {}
    my $back = Proto3::WKT::Empty->from_json_value( {} );  # {}

=head1 DESCRIPTION

Specialization for C<google.protobuf.Empty>, a fieldless message. The binary
wire form is the empty byte string (handled by L<Proto3::Codec>); the proto3
...
Return a fresh canonical L<Proto3::Schema::Message> for the type (no fields).
