...
class Proto3::WKT::Duration {
    ...
    sub to_json_value ( $class, $value ) {
        ...
        my $fraction = Proto3::WKT::Util::fraction_suffix($abs_nanos);
        my $sign = $negative ? '-' : '';
...
Proto3::WKT::Duration - the google.protobuf.Duration well-known type

=head1 SYNOPSIS

    use Proto3::WKT::Duration;

    my $d    = Proto3::WKT::Duration->from_seconds( 1, 500_000_000 );
    my $json = Proto3::WKT::Duration->to_json_value($d);    # '1.500s'
...
L<Proto3::Codec>; this module adds the canonical schema, a C<from_seconds>
...
malformed string raises L<Proto3::Exception::JSON::WKT>.
