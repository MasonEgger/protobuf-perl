...
Proto3::Wire - proto3 wire-format primitives (public facade)
...
C<Proto3::Wire> is the single import surface for proto3 wire-format
primitives. It re-exports the full L<Proto3::Wire::Varint> and
L<Proto3::Wire::Tag> public API and adds the fixed-width and floating-point
...
layer (L<Proto3::Wire::Tag/decode_tag>).
...
remaining bytes. Raises L<Proto3::Exception::Wire::Truncated> on a short
payload and L<Proto3::Exception::Wire::InvalidWireType> for unknown wire types.

=head1 SEE ALSO

L<Proto3::Wire::Varint>, L<Proto3::Wire::Tag>, L<Proto3::Exception>
