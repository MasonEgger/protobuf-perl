...
sub _decode_varint_bigint ($bytes) {
    ...
    while (1) {
        ...
        if ( $i >= MAX_VARINT_BYTES ) {
            Proto3::Exception::Wire::VarintTooLong->throw(
...
Proto3::Wire::Varint - base-128 varint and zigzag encoding for the proto3 wire format
...
L<Proto3::Exception::Wire::Truncated> if the buffer ends with the continuation
bit still set, and L<Proto3::Exception::Wire::VarintTooLong> if no terminator
