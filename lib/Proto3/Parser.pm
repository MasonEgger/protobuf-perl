# ABOUTME: Proto3::Parser — facade over the lexer/grammar (spec §4.4): resolves
...
class Proto3::Parser {
    ...
    method _resolve_path ($rel) {
        ...
        Proto3::Exception::Parser::ImportNotFound->throw(
    ...
    method parse_file ($rel) {
        ...
        open my $fh, '<', $abs
            or Proto3::Exception::Parser::ImportNotFound->throw(
...
Proto3::Parser - parse .proto files into schema definitions
...
=head1 SYNOPSIS
    ...
    # $file is a Proto3::Schema::File instance.
...
L<Proto3::Parser::Lexer> and L<Proto3::Parser::Grammar>, adding include-path
resolution and a per-parser cache so a file requested (or imported) more than
once yields the identical L<Proto3::Schema::File> object.
...
parse it into a L<Proto3::Schema::File>. The result is cached by I<absolute>
...
=item Proto3::Parser->serialize($file)

Render a L<Proto3::Schema::File> back into canonical proto3 source text. The
