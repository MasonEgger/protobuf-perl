# ABOUTME: Proto3::Resolver — proto3 type-name scoping resolution (spec §4.3).
...
# (sub Proto3::Resolver::candidate_names) plus @_ unpacking sidesteps both, so
# resolve() and tests can call Proto3::Resolver::candidate_names reliably.
sub Proto3::Resolver::candidate_names {
...
class Proto3::Resolver {
    ...
    method resolve (%args) {
        ...
        Proto3::Exception::Schema::UnresolvedType->throw(
            message => sprintf(
...
Proto3::Resolver - proto3 type-name scoping resolution
...
=head1 SYNOPSIS
    ...
    # $ref is a Proto3::Schema::Message or Proto3::Schema::Enum, or dies.
...
Construct a resolver over a L<Proto3::Schema>, building the fully-qualified-name
index once.

=item resolve(type_name => ..., current_package => ..., current_message => ...)

Resolve a type reference to its L<Proto3::Schema::Message> or
L<Proto3::Schema::Enum>. On no match, throws
L<Proto3::Exception::Schema::UnresolvedType> carrying C<name>,
