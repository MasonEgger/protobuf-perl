# ABOUTME: Proto3::Class::Accessor — computes a generated class's accessor base
# name from a proto field name, appending "_" on a Perl keyword clash (§4.6).
use v5.38;
use warnings;

package Proto3::Class::Accessor;
...
Proto3::Class::Accessor - Accessor-name computation for generated classes
...
=head2 accessor_name
    ...
    my $base = Proto3::Class::Accessor::accessor_name('package');  # 'package_'
    my $base = Proto3::Class::Accessor::accessor_name('encoding'); # 'encoding'
