...
unique; either collision raises C<Protobuf::Exception::Schema::DuplicateField> at
construction.
...
An arrayref of the message's L<Protobuf::Schema::Field> objects.

=item C<oneofs>

An arrayref of the message's L<Protobuf::Schema::Oneof> objects.
...
An arrayref of nested L<Protobuf::Schema::Message> objects.

=item C<nested_enums>

An arrayref of nested L<Protobuf::Schema::Enum> objects.
