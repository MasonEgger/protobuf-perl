...
are C<Protobuf::Schema::Field> instances that also appear in the owning message's
...
An arrayref of the oneof's member L<Protobuf::Schema::Field> objects.
