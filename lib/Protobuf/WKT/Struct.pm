...
class Protobuf::WKT::Value {
    ...
    sub to_json_value ( $class, $value ) {
        ...
        return Protobuf::WKT::Struct->to_json_value( $value->{struct_value} )
            if exists $value->{struct_value};
        return Protobuf::WKT::ListValue->to_json_value( $value->{list_value} )
    ...
    sub from_json_value ( $class, $json ) {
        ...
        if ( ref $json eq 'ARRAY' ) {
            return { list_value =>
                    Protobuf::WKT::ListValue->from_json_value($json) };
        }
        if ( ref $json eq 'HASH' ) {
            return { struct_value =>
                    Protobuf::WKT::Struct->from_json_value($json) };
        }
...
class Protobuf::WKT::ListValue {
    ...
    sub to_json_value ( $class, $value ) {
        ...
        return [ map { Protobuf::WKT::Value->to_json_value($_) } @$values ];
    }
    ...
    sub from_json_value ( $class, $json ) {
        ...
        return {
            values => [ map { Protobuf::WKT::Value->from_json_value($_) } @$array ]
        };
    }
}
...
class Protobuf::WKT::Struct {
    ...
    sub to_json_value ( $class, $value ) {
        ...
        return {
            map { $_ => Protobuf::WKT::Value->to_json_value( $fields->{$_} ) }
                keys %$fields
        };
    }
    ...
    sub from_json_value ( $class, $json ) {
        ...
        return {
            fields => {
                map { $_ => Protobuf::WKT::Value->from_json_value( $obj->{$_} ) }
                    keys %$obj
            }
        };
    }
...
=head1 SYNOPSIS
    ...
    my $json = Protobuf::WKT::Struct->to_json_value( { a => 1, b => [ 2, 3 ] } );
    my $back = Protobuf::WKT::Struct->from_json_value($json);

    Protobuf::WKT::NullValue->to_json_value(0);     # undef (JSON null)
    Protobuf::WKT::NullValue->from_json_value(undef); # 0
...
=item * C<Protobuf::WKT::ListValue> — a repeated C<Value>; JSON form is a JSON array.

=item * C<Protobuf::WKT::NullValue> — a singleton enum; JSON form is C<null>.
...
Returns a fresh canonical L<Protobuf::Schema::Message> for the type.
(C<Protobuf::WKT::NullValue> instead provides C<schema_enum>, since it is an enum.)

=item C<schema_enum>

I<(C<Protobuf::WKT::NullValue> only.)> Returns a fresh canonical
L<Protobuf::Schema::Enum> for C<google.protobuf.NullValue>.
