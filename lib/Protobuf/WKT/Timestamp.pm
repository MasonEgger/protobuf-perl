...
class Protobuf::WKT::Timestamp {
    ...
    # singular scalars, so the generic Protobuf::Codec encodes/decodes the binary
    ...
    sub to_json_value ( $class, $value ) {
        ...
        my $prefix   = Protobuf::WKT::Util::rfc3339_prefix($seconds);
        my $fraction = Protobuf::WKT::Util::fraction_suffix($nanos);
    ...
    sub from_json_value ( $class, $string ) {
        ...
        my $seconds = Protobuf::WKT::Util::parse_rfc3339_prefix($prefix);
        if ( $zone ne 'Z' ) {
        ...
        my $nanos =
            defined $frac ? Protobuf::WKT::Util::parse_fraction($frac) : 0;
        return { seconds => $seconds, nanos => $nanos };
    }
}
...
=head1 SYNOPSIS
    ...
    my $ts   = Protobuf::WKT::Timestamp->from_epoch( 1_700_000_000, 789_000_000 );
    my $json = Protobuf::WKT::Timestamp->to_json_value($ts); # '2023-11-14T22:13:20.789Z'
...
L<Protobuf::Codec>; this module adds the canonical schema, a C<from_epoch>
...
string raises L<Protobuf::Exception::JSON::WKT>.
